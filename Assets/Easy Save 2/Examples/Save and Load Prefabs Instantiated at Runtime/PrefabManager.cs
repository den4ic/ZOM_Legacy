...
public class PrefabManager : MonoBehaviour 
{
	...
	public string filename = "SavedWeaponPrefabs.txt"; // "SavedPrefabs.txt";
	...
	void LoadPrefab(int tag)
	{
     ...
     //   RectTransform sc = newPrefab.AddComponent<RectTransform>();
        FilterInventory.OnItemClick(newPrefab); // Добавление предмета в экипировку
        newPrefab.transform.SetParent(FilterInventory.transform);
